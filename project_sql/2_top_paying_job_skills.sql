...
-Using the top 10 most paying data analyst jobs from the first query
-Adding the skills required for these jobs
Why? It provides a detailed look on the high paying jobs demand and also for
helping job seekers to understand which skill align with the top paying jobs.
*/
